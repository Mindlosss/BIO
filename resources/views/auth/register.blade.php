<x-guest-layout>
    <div class="mb-6 grid gap-2">
        <div class="text-lg font-semibold text-[color:var(--ink)]">Crear cuenta</div>
        <div class="text-sm text-[color:var(--ink-dim)]">
            Crea una cuenta para guardar y comparar tus simulaciones.
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="grid gap-4">
        ...
        <div class="flex items-center justify-between">
            <a class="text-sm text-[color:var(--ink-dim)] underline decoration-dotted underline-offset-4 hover:text-[color:var(--ink)]" href="{{ route('login') }}">
